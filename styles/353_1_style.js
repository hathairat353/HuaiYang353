var size = 0;
var placement = 'point';
function categories_353_1(feature, value, size, resolution, labelText,
...
var style_353_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("ชื่อสถานที่");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("ชื่อสถานที่") !== null) {
        labelText = String(feature.get("ชื่อสถานที่"));
    }
    
    var style = categories_353_1(feature, value, size, resolution, labelText,
